...
# ╔═╡ 0eeadca6-9964-11ed-3759-bd83104e9447
begin
	using Graphs
...
# ╔═╡ 547bafe8-7291-4101-bc0f-c07abf825cf5
include("graph_utils.jl")

# ╔═╡ b3e4d22e-d030-48ba-af58-f91c83f2606f
...
# ╔═╡ 4e3d534c-1e23-4f7d-a710-ed8e5df1cccd
result = Evolutionary.optimize(
             f, rest_of_things(x, 500),
             GA(populationSize = 700, selection = roulette,
                crossover = CX, mutation = swap2), Evolutionary.Options(iterations=3000))

# ╔═╡ 5652edd5-c278-4644-bb45-4ff10f45d08d


# ╔═╡ 9c5ed26c-e6a0-49ea-bf8b-f2a6fedbcaac
result.minimizer

# ╔═╡ 8a19e042-d4fc-4b20-bb16-238571ba4363
calculate_mindist(g, result.minimizer[1:k], min_dists)

# ╔═╡ 8780beaf-7a46-4d5f-9d5c-50885c0dac6a
result2 = Evolutionary.optimize(
             f, collect(1:500),
             GA(populationSize = 100, selection = roulette,
                crossover = CX, mutation = swap2), Evolutionary.Options(iterations=1000))

# ╔═╡ fe397a58-c380-4420-84ac-8cb2356a65df
calculate_mindist(g, result2.minimizer[1:k], min_dists)
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "ba389f0dc8946dff661209581440787811b55348"
